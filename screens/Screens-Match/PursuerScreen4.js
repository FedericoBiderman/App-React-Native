  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        <Image source={{ uri: './assets/pursuer4.png' }} style={styles.image} />
        <View style={styles.info}>
          <Text style={styles.name}>Sam, 23</Text>
          ...
          <Text style={styles.preference}>Oxford</Text>
          <Text style={styles.preference}>Ingles y Español</Text>
          <Text style={styles.preference}>Desktop Programmer</Text>
          <Text style={styles.preference}>Full-Stack</Text>
          <Text style={styles.preference}>Titulo de Grado</Text>
          <Text style={styles.preference}>Gran Bretaña</Text>
        </View>
      </View>
